class Solution {
    public boolean isIsomorphic(String s, String t) {
        ...
        for(int i=0; i<slen; i++){
            ...
            if(arr[ascii]=='\u0000') arr[ascii]=t.charAt(i);
        ...
        for(int i=0; i<tlen; i++){
            ...
            if(arr2[ascii]=='\u0000') arr2[ascii]=s.charAt(i);
            else if(arr2[ascii]!=s.charAt(i)) return false;
        }
        return true;
    }
}